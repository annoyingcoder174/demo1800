...
function getNameFromAuth() {
    firebase.auth().onAuthStateChanged(user => {
        ...
        if (user) {
            ...
            document.getElementById("display-4").innerText = userName;
...
function writeHikes() {
    ...
    hikesRef.add({
        code: "BBY01",
        name: "Gojo's Oval Glasses", //replace with your own city?
        city: "Burnaby",
        province: "BC",
        level: "easy",
        details: "A vintage style",
    ...
    hikesRef.add({
        code: "AM01",
        name: "Gojo's Circle Glasses", //replace with your own city?
        city: "Surrey",
        province: "BC",
        level: "moderate",
        details: "Transition lenses glasses.",
    ...
    hikesRef.add({
        code: "NV01",
        name: "Gojo's Sunglasses", //replace with your own city?
